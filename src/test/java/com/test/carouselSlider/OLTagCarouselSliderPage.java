...
public class OLTagCarouselSliderPage {

	private RemoteWebDriver driver;
	
	@FindBy(className = "a-carousel")
	...
	public OLTagCarouselSliderPage(RemoteWebDriver driver) {
		this.driver=driver;
	...
	public boolean areSlidesMoving() {
		if(cSlider.getCssValue("transform").equalsIgnoreCase("none")) {
			return false;
		}else {
			return true;
		}
